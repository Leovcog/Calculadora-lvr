package com.example.velascol_parcial2
...
class MainActivity : AppCompatActivity() {
    //Declaramos las variables de numero a ingresar y la de operacio
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //se les da funcion a los botones
...
// funciones de cada boton aqui da condicion para que la app sepa que operacion realizar
